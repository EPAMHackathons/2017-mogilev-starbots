...
namespace NFBot.Models.CompabilityModel
{
    public class QuestionModel
    {
        public static List<QuestionModel> Init()
        {
            ...
            answers1.Add(new AnswerModel() { Code = "А", Value = "спички и топор;" });
            answers1.Add(new AnswerModel() { Code = "Б", Value = "линзу и несколько зерен пшеницы;" });
            answers1.Add(new AnswerModel() { Code = "В", Value = "пляжный зонтик;" });
            answers1.Add(new AnswerModel() { Code = "Г", Value = "томик любимых стихов;" });
            answers1.Add(new AnswerModel() { Code = "Д", Value = "5 кг тротила, чтобы устроить грандиозную рыбалку;" });
            answers1.Add(new AnswerModel() { Code = "Е", Value = "мобильный телефон системы Global Star." });
            List<AnswerModel> answers3 = new List<AnswerModel>();
            answers1.Add(new AnswerModel() { Code = "А", Value = "на их свадьбе отравленное вино лилось бы рекой" });
            answers1.Add(new AnswerModel() { Code = "Б", Value = "здравый смысл восторжествовал бы над многолетней враждой;" });
            answers1.Add(new AnswerModel() { Code = "В", Value = "над влюбленными супругами довлело бы родительское проклятие;" });
            answers1.Add(new AnswerModel() { Code = "Г", Value = "любовь и нежность победили бы все предрассудки;" });
            answers1.Add(new AnswerModel() { Code = "Д", Value = "Шекспир остался бы в памяти современников как никчемный бумагомарака;" });
            answers1.Add(new AnswerModel() { Code = "Е", Value = "они родили бы детей и жили в мире-согласии до глубокой старости." });
            List<AnswerModel> answers4 = new List<AnswerModel>();
            answers1.Add(new AnswerModel() { Code = "А", Value = "фантастический роман Айзека Азимова" });
            answers1.Add(new AnswerModel() { Code = "Б", Value = "'Скотный двор' Оруэлла;" });
            answers1.Add(new AnswerModel() { Code = "В", Value = "Энциклопедию нетрадиционной медицины;" });
            answers1.Add(new AnswerModel() { Code = "Г", Value = "'Унесенные ветром' Маргарет Митчелл;" });
            answers1.Add(new AnswerModel() { Code = "Д", Value = "телефонный справочник;" });
            answers1.Add(new AnswerModel() { Code = "Е", Value = "'Милый друг' Мопассана." });
            ...
            questions.Add(new QuestionModel() { Question = "1. Настоящая любовь - это...", Answers = answers1 });
            questions.Add(new QuestionModel() { Question = "2. Вы возьмете с собой на необитаемый остров...", Answers = answers2 });
            questions.Add(new QuestionModel() { Question = "3. Если бы Ромео и Джульета остались живы и сочетались бы браком, то...", Answers = answers3 });
            questions.Add(new QuestionModel() { Question = "4. Какую из этих книг вы отнесли бы в разряд любимых?", Answers = answers4 });
